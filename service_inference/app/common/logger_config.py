# service_inference/app/common/logger_config.py
import logging
import os
import sys
...
# You might call setup_logger() once at the start of your application.
# For now, we can rely on the first call to get_logger to trigger setup implicitly if needed,
# but it's cleaner to have an explicit setup call in your main entry point.
